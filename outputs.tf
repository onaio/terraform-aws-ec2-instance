...
output "eip" {
  description = "List of elastic IP addresses assigned to the instances, if applicable"
...
output "primary_network_interface_id" {
  ...
  value       = [aws_instance.ec2-instance.*.primary_network_interface_id]
}
...
output "security_groups" {
  ...
  value       = [aws_instance.ec2-instance.*.security_groups]
}

output "vpc_security_group_ids" {
  description = "List of associated security groups of instances, if running in non-default VPC"
  value       = [aws_instance.ec2-instance.*.vpc_security_group_ids]
}
...
output "credit_specification" {
  ...
  value       = [aws_instance.ec2-instance.*.credit_specification]
}
